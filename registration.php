...
if (isset($_REQUEST['name'])){
   ...
   $contact_no = stripslashes($_REQUEST['contact_no']);
	...
	$psw = mysqli_real_escape_string($con,$psw);
        ...
        $query = "INSERT into `users` (name,age,email,contact_no, psw)
VALUES ('$name','$age', '$email','$contact_no', '$psw')";
...
<h2>Registration</h2>
   ...
   <tr> 
   <td></td>
   <td><label><b>Contact_no</b></label></td>
   <td><input type="text" placeholder="Enter your age" name="contact_no" required></td>
