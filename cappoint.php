...
if (isset($_REQUEST['name'])){
  ...
  $email = mysqli_real_escape_string($con,$email);
    ...
    $contact = mysqli_real_escape_string($con,$contact); 
        ...
        $query = "INSERT into `appointment` (id,name,email,age,contact)
VALUES ('$ID','$name', '$email','$age','$contact')";
...
<form name="registration" action="" method="post" >
  ...
  <div class="container__child signup__thumbnail">
    <div class="thumbnail__logo">
      ...
      <h1 class="logo__text">Dr.Rutuja Nighot</h1><br>
      <h1 class="logo__text">BHMS</h1><br>
      <h1 class="logo__text">Homeopath</h1>
    </div>
    <div class="thumbnail__content text-center">
      <img src="img\rutu.jpg" alt="Smiley face" width="100" height="100"></img>
  ...
  <div class="container__child signup__form">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="email" id="email" placeholder="rutu.nighot@gmail.com" required />
      </div>
      <div class="form-group">
